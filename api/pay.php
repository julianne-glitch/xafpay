...
$stmt = $pdo->prepare("
    INSERT INTO payments (
        session_id, order_id, phone_number, carrier, amount, currency,
        reference_id, status, callback_sent, created_at, updated_at
    ) VALUES (
        :session, :order_id, :phone, 'MTN', :amount, 'XAF',
        :ref, 'PENDING', FALSE, NOW(), NOW()
    )
");
